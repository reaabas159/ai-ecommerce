          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-muted-foreground">
                ...
                <span>support@trendshop.com</span>
              </div>
              <div className="flex items-center space-x-3 text-muted-foreground">
        ...
        <div className="glass-panel mb-12">
          ...
          <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <input
              ...
              className="flex-1 px-4 py-3 bg-secondary text-white dark:text-white border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-black dark:text-black placeholder-muted-foreground"
            />
            <button
              type="submit"
