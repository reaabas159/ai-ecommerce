        ...
        <div className="bg-white rounded-xl w-full max-w-2xl p-6 relative">
          ...
          >
            <input
              ...
              className="border px-4 py-2 text-black dark:text-black rounded"
            />
            <select
              className="w-full border p-2 text-black dark:text-black rounded-lg bg-white"
            ...
            <input
              ...
              className="border px-4 py-2 text-black dark:text-black rounded col-span-1 md:col-span-2"
            />
