...
export const postProductReview = catchAsyncErrors(async (req, res, next) => {
  ...
  const userId = req.user.id; // Store user ID to ensure we use the correct one
  ...
  // Fetch the review with reviewer information
  const reviewWithUser = await database.query(
    `
    SELECT 
      r.id AS review_id,
      r.rating,
